...
\SetBgAngle{0}
\SetBgColor{red}
\SetBgContents{\rule[0em]{1pt}{\textheight}}
\SetBgHshift{-2.3cm}
\SetBgVshift{0cm}
...
\begin{tcolorbox}[colframe=white,opacityback=0]
\begin{tcolorbox}[enhanced,colframe=white,fonttitle=\large\bfseries\sffamily,sidebyside=true, nobeforeafter,before=\vfil,after=\vfil,colupper=black,sidebyside align=top, lefthand width=.95\textwidth,opacitybacktitle=1, opacitytext=1,
