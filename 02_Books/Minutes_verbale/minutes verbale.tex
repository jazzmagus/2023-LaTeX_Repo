...
\title {\textbf {\Huge {Verbali}} \\Protokollsammlung\\[1cm]
minutes.sty}
...
%\inputminutes{SampleIT}%An italian minutes
...
\anhang[att:en]{Attachment with reference}{2} 51
...
\vote{Short voting}{1}{2}{3}[Decision] 77
