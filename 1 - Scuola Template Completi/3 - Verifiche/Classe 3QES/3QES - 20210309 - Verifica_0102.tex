...
\textbf{Avvertenze}:
\begin{itemize}
	\item La presente Verifica - che viene somministrata in modalità DDI - contiene \numquestions \; quesiti, per un totale di \numpoints \;punti, uno dei quali facoltativo, il quale verrà valutato soltanto se saranno stati risolti anche tutti gli altri.
...
%\begin{parts}
%\part[4]
%Quando due o più monomi si dicono {\bfseries simili}?\ Puoi fare un esempio numerico?
%%\fillwithlines{0.75in}
%{\footnotesize
%\begin{solution}
%Due o più monomi si dicono simili quando presentano la stessa parte letterale; ad es sono simili: \(3ab^2, -6ab^2\) e \(\dfrac{1}{2}ab^2\).
%\end{solution}
%}
%\vspace{.5cm}
%\part[5]
...
% ------------------------------------- Esercizio 4
\addpoints
\question [4] Affinché si possa eseguire una divisione tra monomi, gli esponenti della parte letterale del dividendo devono essere:\\
...
%\vfill
%\newpage
% ------------------------------- Esercizio 6 - Facoltativo (bonus points)
\noindent
...
\end{center}
\vspace{4pt}
\footnotesize La sufficienza è fissata a 18 punti, ma potrà subire delle modifiche in fase di correzione, al fine di garantire la validità della prova anche nel caso in cui si riscontrassero prestazioni della classe sensibilmente lontane dalla media prevista.
