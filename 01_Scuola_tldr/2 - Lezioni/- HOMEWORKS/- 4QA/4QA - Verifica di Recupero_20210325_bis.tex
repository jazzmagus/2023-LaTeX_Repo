...
\newcommand{\examnum}{num.: 02 | 02 R2}
\newcommand{\examdate}{25 marzo 2021}
...
\runningheader{\footnotesize VERIFICA di Recupero di MATEMATICA}{}{Classe 4\string^QE}
\runningheadrule
...
\addpoints
\question
Determina le soluzioni delle seguenti espressioni di secondo grado e utilizzale per fattorizzare il polinomio:\\
\begin{parts}
\part[5]
\(-\dfrac{3}{4}x^2 - 1 = 0\)\\
...
\[\dfrac{1}{4}x^2 - 2x + 4 \ge 0 \]
\fillwithdottedlines{0.75in}

{\footnotesize
\begin{solution}
	\(S = \{\forall x \in \mathbb{R}\}\) 
\end{solution}
}
\pagebreak
% ------------------------------------- Esercizio 3
\addpoints
\question [8] Data la seguente funzione quadratica \[y = -\dfrac{1}{9}x^2 + 2x - 9\] Ricostruisci il grafico dopo averne determinato le coordinate dei punti di intersezione con gli assi e quelle del Vertice.\\

\includegraphics[width=\textwidth, fbox]{grafico_empty}
%\includegraphics[width=\textwidth]{grafico_empty}
\fillwithdottedlines{1in}
{\footnotesize
\begin{solution}	
	\includegraphics[width=\textwidth]{graph_03_bis.png}\\
\end{solution}
}
\pagebreak
% ------------------------------------- Esercizio 4
\addpoints
\question [6]
Quello riportato in figura è il grafico di una determinata funzione di secondo grado del tipo \(y = ax^2 + bx + c\);\\
...
%\includegraphics[width=\textwidth, fbox]{graph_es4_ter.png}
\includegraphics[width=\textwidth, frame]{graph_es4_ter.png}
\end{questions}
\vfill
