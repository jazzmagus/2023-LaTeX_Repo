...
%
% Authors:
% Diego Fantinelli (jazzmagus@gmail.com)
%
% License:
...
%%
%\datenotesstarted{20 settembre 2015} % The date when these notes were first made
%\docdate{\datenotesstarted; rev. \today} % The date when the notes were lasted updated (automatically the current date)

%\docauthor{\em Diego Fantinelli} % Your name
